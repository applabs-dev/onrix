...
func SetApiRouter(router *gin.Engine) {
	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		apiRouter.POST("/lemonsqueezy/webhook", anonymousRequestBodyLimit, controller.LemonSqueezyWebhook)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/lemonsqueezy/pay", middleware.CriticalRateLimit(), controller.RequestLemonSqueezyPay)
		...
		subscriptionRoute.Use(middleware.UserAuth())
		{
			...
			subscriptionRoute.POST("/lemonsqueezy/pay", middleware.CriticalRateLimit(), controller.SubscriptionRequestLemonSqueezyPay)
